...
class AsyncValuePractice extends ConsumerStatefulWidget {
  const AsyncValuePractice({super.key});

  @override
  ConsumerState createState() {
    return AsyncValuePracticeState();
  }
}

class AsyncValuePracticeState extends ConsumerState<AsyncValuePractice> {
  var _skipLoadingOnRefresh = true;
  var _skipLoadingOnReload = false;
